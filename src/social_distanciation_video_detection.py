...
for section in cfg:
	...
	size_frame = "../img/static_frame_from_video.jpg"
...
if model_num == "":
	...
	model_path = "/home/autolab/dl/tracking/csd_detection/models/faster_rcnn_inception_v2_coco_2018_01_28/frozen_inference_graph.pb"
...
while True:	
	...
	if not frame_exists:
		...
		sizeframe = 800
		frame = imutils.resize(frame, width=int(sizeframe))
